...
-(void)update:(int)tag {
    [UIView animateWithDuration:0.3 animations:^{
        ...
        if([state isEqualToString:State_PlantType]) [self addLeftNavButtonWithImageNamed:Image_Navigation_DismissButton toNavigationItem:self.navigationItem withSelector:@selector(backPushed:)];
